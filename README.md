...
| XPan 135 宽幅 | 65×24mm | 自动 3 | 横图 | 与普通 135 等高，仅增长长边 |
| 135 宽幅（6×9 相机） | 约 84×24mm | 自动 2 | 横图 | 与普通 135 等高，画面约跨 18 个齿孔节距 |
...
135 宽幅与普通 135 共用 24mm 中央成像高度和 35mm 胶片总高度，尺寸基准始终对应标准 36mm 画幅宽度。XPan 65×24mm 与约 84×24mm 格式只增长长边，单行张数会按固定六格 135 片条宽度自动调整。
